...
declare function getFunctionFailedMessage(name: string): string;
...
export declare const FUNCTION_FAILED_WAIT_FOR_RENDER: typeof getFunctionFailedMessage;
...
export declare const FAILED_TO_FETCH_HISTORY = "Failed to fetch history";
export {};
