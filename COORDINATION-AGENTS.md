...
| **P4-APP-SAAS** | **Refonte app Mia = SaaS de gestion pour les propriétaires de sites clients (multi-tenant, 12 secteurs) + landing sectorielle** | 🔄 **Audit fait, plan écrit** | `unified-ia-backend/docs/refonte-app-mia/` — `AUDIT-PREALABLE.md` (10 recommandations, dont C2 « ne jamais vendre ce qui n'est pas branché » et C4 RGPD), `PLAN-COMPLET.md` (14 écrans, 12 secteurs validés contre `sectors.py`, 4 chantiers backend B1-B4), `CONSIGNE-SITE.md`. ⚠️ DEMANDE UI déposée ci-dessous. |
